  ...
  return (
    <>
      <>
        {" "}
        <div>
          <div className={` absolute px-[1rem] w-full  z-10 `}>
              ...
              <div className="flex md:justify-center justify-start bg-[#fff] text-center ">
                ...
                >
                  ...
                  <li className="md:flex hidden justify-center text-center">
                    <Link href="/login">
                      {" "}
                      <button className="lg:py-15 bg-[#00c194] lg:px-[1.38rem] px-3 py-2.5 lg:w-[141px] w-[100px] rounded-md flex justify-center items-center text-white">
                        Sign Up
                      </button>
                    </Link>
                  </li>
        ...
        <div className={`absolute justify-center flex left-0 right-0`}></div>
        <div className="absolute pt-[108px]  justify-center flex left-0 right-0"></div>
      </>
    </>
  );
}
