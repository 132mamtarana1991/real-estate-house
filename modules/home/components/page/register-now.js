...
export default function RegisterNow() {
  return (
    <div className=" bg-[#eaf7f4] relative mt-15">
      <div className="absolute w-[302px] left-0 bottom-0">
        {" "}
        <img
      ...
      <div className="grid grid-cols-3 gap-4 max-w-[1020px] mx-auto">
        <div className="...">
        ...
        <div className="col-span-2 mt-8">
          ...
          <button
            type="button"
            className="text-[#fff] mt-1 px-8 py-4 bg-[#00c194] hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-lime-300 dark:focus:ring-lime-800  shadow-lg shadow-lime-500/50 dark:shadow-lg dark:shadow-lime-800/80 font-medium rounded-sm text-sm  text-center mr-2 mb-2"
          >
            Contact With Us
          </button>
        </div>
      </div>
      <div className=" absolute w-[302px] right-0 bottom-0">
        {" "}
        <img
          className="opacity-20 brightness-[80%] contrast-[102%] saturate-[100%] blur-none hue-rotate-[360deg];"
          src="./images/video-bg-2.svg"
